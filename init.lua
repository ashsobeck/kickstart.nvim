...
-- Diagnostic keymaps
vim.keymap.set('n', '<M-k>', ':cprev<CR>', { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', '<M-j>', ':cnext<CR>', { desc = 'Go to next [D]iagnostic message' })
...
vim.keymap.set('n', '<leader>nt', ':term<CR>', { desc = 'New terminal' })
